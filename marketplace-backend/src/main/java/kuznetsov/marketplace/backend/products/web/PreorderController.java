...
import kuznetsov.marketplace.backend.products.service.PreorderService;
...
public class PreorderController {
    ...
    public ResponseEntity<PreorderDtoPage> getAllCurrentUserPreordersPage(
        ...
        String userEmail = principal != null
                ? principal.getName()
                : null;
        UserDto user = userService.getUserByEmailOrNull(userEmail);
        Role currentRole = user != null
                ? user.getRole()
                : null;
        log.info(
